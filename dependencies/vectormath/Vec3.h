...
{
public:
	static const char* StringFormat() { return "[ %g %g %g ]"; }
	static const char* StringFormatBare() { return "%g %g %g"; }
};
...
{
public:
	static const char* StringFormat() { return "[ %.6g %.6g %.6g ]"; }
	static const char* StringFormatBare() { return "%.6g %.6g %.6g"; }
};
...
{
public:
	static const char* StringFormat() { return "[ %.10g %.10g %.10g ]"; }
	static const char* StringFormatBare() { return "%.10g %.10g %.10g"; }
};
...
template <class vreal>
 int Vec3T<vreal>::MakeOrthonormalBasis(VecBase3T<vreal> & base1, VecBase3T<vreal> & base2)
{
