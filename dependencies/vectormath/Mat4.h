...
template <class FT>
 Mat4T<FT> operator + (const Mat4T<FT>& a, const Mat4T<FT>& b)
{
	Mat4T<FT> c;
...
template <class FT>
 Mat4T<FT> operator * (const Mat4T<FT>& b, const Mat4T<FT>& a)
{
	Mat4T<FT> c;
...
template <class FT>
 Mat4T<FT> operator * (const Mat4T<FT>& a, const FT d)
{
	Mat4T<FT> b;
	b.XX = a.XX * d;
	b.XY = a.XY * d;
...
template <class FT>
 Mat4T<FT> operator * (const FT d, const Mat4T<FT>& a)
{ return a*d; }


template <class FT>
 Vec3T<FT> operator * (const Vec3T<FT>& v3, const Mat4T<FT>& m4)
{
...
template <class FT>
 Vec3T<FT> operator * (const Mat4T<FT>& m4, const Vec3T<FT>& v3)
{
	// multiply v3 as though it were v4 with w = 1
	Vec4T<FT> v4;
	Vec3T<FT> ret;
...
template <class FT>
 Vec4T<FT> operator * (const Vec4T<FT>& v, const Mat4T<FT>& a)
{
	return Vec4T<FT> (
...
template <class FT>
 Vec4T<FT> operator * (const Mat4T<FT>& a, const Vec4T<FT>& v)
{
	return Vec4T<FT> (
...
template <class FT>
 bool operator == (const Mat4T<FT>& a, const Mat4T<FT>& b)
{
