 ...
 *   final null byte.
 */
MODP_API size_t modp_burl_encode(char* dest, const char* str, size_t len);
 ...
 *   final null byte.
 */
MODP_API size_t modp_burl_min_encode(char* dest, const char* str, size_t len);
 ...
 */
MODP_API size_t modp_burl_min_encode_strlen(const char* src, const size_t len);
 ...
 *   null byte.
 */
MODP_API size_t modp_burl_encode_strlen(const char* str, const size_t len);
 ...
 */
MODP_API size_t modp_burl_decode(char* dest, const char* str, size_t len);
 ...
 * \return the strlen of the output string.
 */
MODP_API size_t modp_burl_decode_raw(char* dest, const char* str, size_t len);
