...
MODP_API size_t modp_itoa10(int32_t value, char* str)
{
    char* wstr=str;
    // Take care of sign
...
MODP_API size_t modp_uitoa10(uint32_t value, char* str)
{
    char* wstr=str;
    // Conversion. Number is reversed.
...
MODP_API size_t modp_litoa10(int64_t value, char* str)
{
    char* wstr=str;
...
MODP_API size_t modp_ulitoa10(uint64_t value, char* str)
{
    char* wstr=str;
    // Conversion. Number is reversed.
    do *wstr++ = (char)(48 + (value % 10)); while (value /= 10);
...
MODP_API size_t modp_dtoa(double value, char* str, int prec)
{
    /* Hacky test for NaN
...
MODP_API size_t modp_dtoa2(double value, char* str, int prec)
{
    /* Hacky test for NaN
     * under -fast-math this won't work, but then you also won't
     * have correct nan values anyways.  The alternative is
...
MODP_API char* modp_uitoa16(uint32_t value, char* str, int isfinal)
{
