 ...
 */
MODP_API size_t modp_itoa10(int32_t value, char* buf);
 ...
 * \param[out] buf The output buffer, should be 16 chars or more.
 */
MODP_API size_t modp_uitoa10(uint32_t value, char* buf);
 ...
 */
MODP_API size_t modp_litoa10(int64_t value, char* buf);
 ...
 * \param[out] buf The output buffer, should be 24 chars or more.
 */
MODP_API size_t modp_ulitoa10(uint64_t value, char* buf);
 ...
 *    Can only be 0-9.
 */
MODP_API size_t modp_dtoa(double value, char* buf, int precision);
 ...
 *    Can only be 0-9.
 */
MODP_API size_t modp_dtoa2(double value, char* buf, int precision);

/**
 * adds a 8-character hexadecimal representation of value
 *
 */
MODP_API char* modp_uitoa16(uint32_t value, char* buf, int final);
