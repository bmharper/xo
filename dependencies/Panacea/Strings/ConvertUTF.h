...
XStringW	PAPI ConvertUTF8ToUTF16( const XStringA& src );
XStringA	PAPI ConvertUTF16ToUTF8( const XStringW& src );
...
**/
bool		PAPI ConvertUTF16ToUTF8( const wchar_t* src, size_t srcLen, char* dst, size_t& dstLen, bool relaxNullTerminator = false );

/// Analogue of ConvertUTF16ToUTF8
bool		PAPI ConvertUTF8ToUTF16( const char* src, size_t srcLen, wchar_t* dst, size_t& dstLen, bool relaxNullTerminator = false );

/// First assumes that src contains only ASCII characters.
bool		PAPI ConvertUTF16ToUTF8_Optimistic( const wchar_t* src, size_t srcLen, char* dst, size_t& dstLen, bool relaxNullTerminator = false );
