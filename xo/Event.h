...
enum Events {
	...
	// For further details of the EventDocLifecycle message, look inside Event.DocLifecycle.
	EventDocLifecycle = 131072,
};
...
public:
	...
	xo::DocLifecycleEvents  DocLifecycle = DocLifecycleEvents::Null; // Only valid when Type = EventDocLifecycle
