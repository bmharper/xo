...
const char* GLProg_Arc::FragSrc() {
	return "uniform		vec2	vport_hsize;\n"
	       "\n"
	       "varying		vec4	pos;\n"
...
const char* GLProg_Arc::Name() {
	return "Arc";
}

bool GLProg_Arc::LoadVariablePositions() {
	int nfail = 0;
...
uint32_t GLProg_Arc::PlatformMask() {
	return Platform_All;
}
