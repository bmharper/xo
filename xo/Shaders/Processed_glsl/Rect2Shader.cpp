...
const char* GLProg_Rect2::VertSrc() {
...
const char* GLProg_Rect2::FragSrc() {
	return "//#define SHADERTOY\n"
	       "\n"
...
const char* GLProg_Rect2::Name() {
	return "Rect2";
}

bool GLProg_Rect2::LoadVariablePositions() {
	int nfail = 0;
...
uint32_t GLProg_Rect2::PlatformMask() {
	return Platform_All;
}
