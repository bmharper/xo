...
const char* GLProg_Rect::VertSrc() {
...
const char* GLProg_Rect::FragSrc() {
...
const char* GLProg_Rect::Name() {
	return "Rect";
}

bool GLProg_Rect::LoadVariablePositions() {
	int nfail = 0;
...
uint32_t GLProg_Rect::PlatformMask() {
	return Platform_All;
}
