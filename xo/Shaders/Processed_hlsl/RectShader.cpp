...
void DXProg_Rect::Reset()
{
	ResetBase();

}

const char* DXProg_Rect::VertSrc()
{
	return
		"\n"
...
const char* DXProg_Rect::FragSrc()
{
	return
		"\n"
		"cbuffer PerFrame : register(b0)\n"
...
const char* DXProg_Rect::Name()
{
	return "Rect";
}


bool DXProg_Rect::LoadVariablePositions()
{
	int nfail = 0;
...
uint32_t DXProg_Rect::PlatformMask()
{
	return Platform_All;
}
