...
void DXProg_FillTex::Reset()
{
	ResetBase();

}

const char* DXProg_FillTex::VertSrc()
{
	return
		"\n"
...
const char* DXProg_FillTex::FragSrc()
{
	return
		"\n"
		"cbuffer PerFrame : register(b0)\n"
...
const char* DXProg_FillTex::Name()
{
	return "FillTex";
}


bool DXProg_FillTex::LoadVariablePositions()
{
	int nfail = 0;
...
uint32_t DXProg_FillTex::PlatformMask()
{
	return Platform_All;
}

xo::VertexType DXProg_FillTex::VertexType()
{
