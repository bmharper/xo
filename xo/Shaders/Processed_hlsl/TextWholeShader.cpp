...
void DXProg_TextWhole::Reset()
{
	ResetBase();

}

const char* DXProg_TextWhole::VertSrc()
{
	return
		"\n"
...
const char* DXProg_TextWhole::FragSrc()
{
	return
		"\n"
		"cbuffer PerFrame : register(b0)\n"
...
const char* DXProg_TextWhole::Name()
{
	return "TextWhole";
}


bool DXProg_TextWhole::LoadVariablePositions()
{
	int nfail = 0;
...
uint32_t DXProg_TextWhole::PlatformMask()
{
	return Platform_All;
}
